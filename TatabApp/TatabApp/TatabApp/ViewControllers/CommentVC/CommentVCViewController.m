...
-(BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string{
    ...
    if (textField.text.length + string.length > 250 && ![string isEqualToString: @""]) {
        [self addAlertWithTitle:[Langauge getTextFromTheKey:AlertKey] andMessage:@"The comment length is more than 250 characters." isTwoButtonNeeded:false firstbuttonTag:100 secondButtonTag:0 firstbuttonTitle:[Langauge getTextFromTheKey:OK_Btn] secondButtonTitle:nil image:Warning_Key_For_Image];
        return false;
    }
